...
<head>
  ...
  <meta content="⚙⚙️⚙️ Запчасти для собственного производства автожира  " name="description" />
  <meta name="keywords" content="запчасти автожиров, самостоятельная сборка автожира, обслуживание автожира, регламент обслуживаиния автожира, Танго Тревел, Танго+">
  ...
  <title>Комплектующие для автожиров</title>
  <!-- Иконки сайта -->
	...
	"itemListElement": [
		{
			...
			"position": 1,
			"name": "Запчасти",
			"item": "http://autogyro-izhevsk.com/services"
		}
	]
}
</script>
...
<body>
		...
		<div class="container d-flex align-items-center">
			...
			<nav class="navbar order-last order-lg-0" id="navbar">
				<ul>
					...
					<li>
						<a class="active" href="http://autogyro-izhevsk.com/services">Запчасти</a>
					</li>
					<li class="dropdown">
	...
	<main id="main">
		...
		<section class="services" id="services" style="margin-top: 70px; background-color: #fff;">
			<div class="container" data-aos="fade-up">
				<div class="section-title">
					<h2>Комплектующие</h2>
					<strong>Мы рады предложить Вам отдельные узлы агрегаты для самостоятельной постройки автожира.</strong>
				</div>
				<div class="row justify-content-center">
					<div class="col-lg-12 col-md-12 align-items-stretch mt-4" data-aos-delay="200">
						<div class="card">
							<div class="inner"><img alt="отдельные узлы агрегаты для самостоятельной постройки автожира." title="отдельные узлы агрегаты для самостоятельной постройки автожира." class="card-img-top" data="http://autogyro-izhevsk.com/assets/img/комплектующие/cat1.jpg" src=""></div>
						</div>
					</div>
					<div class="col-lg-12 col-md-12 align-items-stretch mt-5" data-aos-delay="200">
						<div class="card">
							<div class="inner"><img alt="отдельные узлы агрегаты для самостоятельной постройки автожира." title="отдельные узлы агрегаты для самостоятельной постройки автожира." class="card-img-top" data="http://autogyro-izhevsk.com/assets/img/комплектующие/cat2.jpg" src=""></div>
						</div>
					</div>
					<div class="col-lg-12 col-md-12 align-items-stretch mt-5" data-aos-delay="200">
						<div class="card">
							<div class="inner"><img alt="отдельные узлы агрегаты для самостоятельной постройки автожира." title="отдельные узлы агрегаты для самостоятельной постройки автожира." class="card-img-top" data="http://autogyro-izhevsk.com/assets/img/комплектующие/cat3.jpg" src=""></div>
						</div>
					</div>
					<div class="col-lg-12 col-md-12 align-items-stretch mt-5" data-aos-delay="200">
						<div class="card">
							<div class="inner"><img alt="отдельные узлы агрегаты для самостоятельной постройки автожира." title="отдельные узлы агрегаты для самостоятельной постройки автожира." class="card-img-top" data="http://autogyro-izhevsk.com/assets/img/комплектующие/cat4.jpg" src=""></div>
						</div>
					</div>
					<div class="col-lg-12 col-md-12 align-items-stretch mt-5" data-aos-delay="200">
						<div class="card">
							<div class="inner"><img alt="отдельные узлы агрегаты для самостоятельной постройки автожира." title="отдельные узлы агрегаты для самостоятельной постройки автожира." class="card-img-top" data="http://autogyro-izhevsk.com/assets/img/комплектующие/cat55.jpg" src=""></div>
						</div>
					</div>
				</div>
				<div data-aos="fade-up" class="text-center mt-5">
				    <span>Если у вас возникли дополнительные вопросы, свяжитесь с нами по номеру  <a href="tel:+79124448858" style="noopener"><span style="color: rgb(255, 52, 0);">8 (912) 444-88-58</span></a><br>Мы с радостью поможем!</span>
				</div>
			</div>
		</section>
